    ...
    <section id="veiculos" className="py-20 bg-[#0D1117]">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="flex items-end justify-between mb-12">
          ...
          <a href="#" className="hidden md:flex btn-ghost px-5 py-2.5 rounded-lg text-sm items-center gap-2">
            Ver todos
        ...
        {!loading && cars.length === 0 && (
          <div className="glass-card rounded-2xl p-16 text-center">
            <p className="font-rajdhani font-bold text-xl text-white mb-2">Nenhum veículo disponível</p>
            <p className="text-sm text-[#8b90a1] font-inter">Em breve novos veículos estarão disponíveis.</p>
          </div>
        )}
        ...
        {!loading && cars.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {cars.map((car) => (
              ...
              >
                {/* Image */}
                <div className="relative h-52 overflow-hidden bg-[#1c2026]">
                  {car.images[0] ? (
                    <Image
                      src={car.images[0]}
                      alt={car.name}
                  ...
                  {car.images.length > 1 && (
                    <span className="absolute bottom-3 right-3 bg-black/60 text-white text-xs px-2 py-0.5 rounded-full font-inter">
        ...
        {!loading && cars.length > 0 && (
          <div className="mt-8 flex justify-center md:hidden">
            <a href="#" className="btn-ghost px-6 py-2.5 rounded-lg text-sm">
