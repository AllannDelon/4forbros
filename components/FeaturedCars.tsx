          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((car) => (
              <div key={car.id} className="glass-card rounded-2xl overflow-hidden glow-hover group flex flex-col">
                {/* Image — maior para dar destaque visual */}
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <div className="flex gap-2 mt-auto">
                    ...
                    <a
                      href={`https://wa.me/5592982291000?text=${encodeURIComponent(`Olá! Gostaria de saber mais sobre o ${car.name} ${car.year}. Qual a disponibilidade?`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
