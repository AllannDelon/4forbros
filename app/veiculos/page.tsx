              ...
              <div key={car.id} className="glass-card rounded-2xl overflow-hidden glow-hover group flex flex-col">
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-4">
                    {[{ icon: "🛣️", val: car.km }, { icon: "⚙️", val: car.transmission }, { icon: "⚡", val: car.power }]
                      .map(({ icon, val }) => (
                  ...
                  <div className="flex flex-col gap-2 mt-auto">
                    ...
                    <a href={`https://wa.me/5592982291000?text=${encodeURIComponent(`Olá! Gostaria de agendar uma visita para ver o ${car.name} ${car.year}.`)}`}
                      target="_blank" rel="noopener noreferrer"
